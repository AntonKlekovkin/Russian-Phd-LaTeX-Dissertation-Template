...
Коэффициенты присоединенных масс описывают силы и моменты инерционной природы как при ускоренном движении тела в идеальной жидкости, так и при его установившемся перемещении. %Присоединенные массы описывают сопротивление среды пропорционально ускорению тела.
%При движении тела в невязкой жидкости ее инерционные свойства определяются присоединенными массами.
...
1. $t_1 \neq t_3$, $t_2 = t_4$ с; \quad	$ \Omega_1 = \Omega_{max} $, $ \Omega_2 = -\Omega_{max} $; \quad $ k_1 = t_3 / t_1 $
	...
	{Угловая скорость ротора}
			\center{\includegraphics[width=0.6\linewidth]{ControlActionCircle1.eps}}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.47\linewidth}
...
\begin{minipage}[t]{0.47\linewidth}
	{Угловая скорость ротора}
	\center{\includegraphics[width=0.6\linewidth]{ControlActionCircle2.eps}}
\end{minipage}
\hfill
\begin{minipage}[t]{0.47\linewidth}
	{Траектория движения робота}
...
\begin{itemize}
	...
	\item Патент на полезную модель. №172254 РФ. Безвинтовой подводный робот //  А.В. Борисов, И.С. Мамаев, А.А. Килин, А.А. Калинкин, Ю.Л. Караваев, \textbf{А.В. Клековкин}, Е.В. Ветчанин; %заявитель и патентообладатель – ФБГОУ ВО «ИжГТУ имени М.Т. Калашникова»; Заявка: 2016144812, 15.11.2016, опубл. 
	3.07.2017
		
	\item № 2017613219. Программа для управления безвинтовым подводным роботом // А.В. Борисов, И.С. Мамаев, А.А. Килин, Ю.Л. Караваев, \textbf{А.В. Клековкин}. %Заявитель и патентообладатель – ФБГОУ ВО «ИжГТУ имени М.Т. Калашникова»; Заявка: 2016662663, 22.11.2016, опубл. 
	16.03.2017
		
	\item № 2019612284. Программа управления безвинтовым надводным роботом с внутренним ротором // А.В. Борисов, И.С. Мамаев, А.А. Килин, \textbf{А.В. Клековкин}, Ю.Л. Караваев. %Заявитель и патентообладатель – ФБГОУ ВО "ИжГТУ имени М.Т. Калашникова"; Заявка: 2019610925, 04.02.2019, опубл. 
	14.02.2019
\end{itemize}
