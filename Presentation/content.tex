...
\begin{frame}
\frametitle{\todo{Мобильный робот в форме эллипсоида}}
Конструкция и корпусные элементы экспериментальной модели безвинтового подводного робота \todo{Увеличить цифры}
\begin{figure}[h]
	\centering
