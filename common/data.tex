...
{Исследование движения роботов в жидкости, управляемых внутренними механизмами}
...
{{ФГБОУ ВО "Юго-западного государственного университета"}}
...
{{д.т.н, доцент}}            % Для сокращений есть ГОСТы, например: ГОСТ Р 7.0.12-2011 + http://base.garant.ru/179724/#block_30000
